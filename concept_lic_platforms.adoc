...
.3+| SSD(Solid State Drive)는 ... | 하드웨어 RAID 구성 | 아니요 | 예 | 예 
...
표준, 프리미엄 및 프리미엄 XL 라이센스 제품은 다양한 하드웨어 및 소프트웨어를 지원합니다. 하드웨어 및 소프트웨어 버전에 대한 최신 정보는 link:https://mysupport.netapp.com/matrix/["상호 운용성 매트릭스 툴"^]을(를) 참조하십시오.
...
2+| CPU 제품군  a| 
Intel Xeon E5-26xx v3(Haswell) 이상

AMD EPYC Embedded 9004 이상 및 8004
 a| 
Intel Xeon E5-26xx v3(Haswell) 이상
...
Rocky Linux (KVM) 10.1, 10.0, 9.7, 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0, 8.9, 8.8, 8.7 및 8.6
...
====
.다음은 무엇인가요?
link:concept_lic_workflow.html["ONTAP Select 라이센스 구매"]에 대해 알아보십시오
