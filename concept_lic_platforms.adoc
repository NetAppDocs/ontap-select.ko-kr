...
2+| 하이퍼바이저 지원(KVM)  a| 
Red Hat Enterprise Linux 64비트(KVM) 10.0, 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0, 8.8, 8.7 및 8.6

Rocky Linux(KVM) 10.0, 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0, 8.9, 8.8, 8.7 및 8.6

*참고*: RHEL 10.0 및 Rocky Linux 10.0 호스트의 KVM 하이퍼바이저에는 소프트웨어 RAID 워크플로에 제한 사항이 있습니다. 자세한 내용은 다음 기술 자료 문서를 참조하십시오.
