...
NOTE: 하이퍼바이저 호스트에서 vSwitch를 구성하는 방법과 고속 인터페이스 기능에 대한 자세한 내용은 link:concept_nw_concepts_chars.html["딥 다이브 네트워킹"] 섹션을 참조하십시오.
...
2-NIC 구축에 대한 자세한 내용은 link:concept_nw_concepts_chars.html["딥 다이브 네트워킹"] 섹션을 참조하십시오.
...
4-NIC 배포에 대한 자세한 내용은 link:concept_nw_concepts_chars.html["딥 다이브 네트워킹"] 섹션을 참조하십시오.
