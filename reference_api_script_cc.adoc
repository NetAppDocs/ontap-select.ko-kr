...
summary: 다음 스크립트를 사용하여 스크립트 및 JSON 입력 파일 내에 정의된 매개 변수를 기반으로 클러스터를 생성할 수 있습니다. 
---
= ONTAP Select 클러스터를 생성하기 위한 스크립트
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
다음 스크립트를 사용하여 스크립트 및 JSON 입력 파일 내에 정의된 매개 변수를 기반으로 클러스터를 생성할 수 있습니다.
