...
summary: Capacity Tiers 라이센스 모델과 Capacity Pools 라이센스 모델에는 몇 가지 차이점이 있습니다. 
---
= ONTAP Select 용량 등급 및 용량 풀 라이센스 비교
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
| 라이센스 일련 번호입니다 | NetApp은 9자리 숫자를 생성하여 노드에 할당합니다 | NetApp은 9자리 숫자를 생성하여 용량 풀에 할당합니다. 


| 사용권 잠금 | ONTAP Select 노드에 대해 잠겨 있습니다 | License Manager 인스턴스에 잠겼습니다 


| 라이센스 기간 | 영구(갱신 필요 없음) | 구매를 기준으로 한 고정 기간(갱신 필요) 
...
| 최대 관리 공간 | 노드당 400 TiB | 노드당 400 TiB 
|===