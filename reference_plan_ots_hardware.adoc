...
* Red Hat Enterprise Linux(RHEL) 10.0, 9.6, 9.5, 9.4, 9.2, 9.1, 9.0, 8.8, 8.7 및 8.6 버전에서 KVM 사용
* Rocky Linux 10.0, 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0, 8.9, 8.8, 8.7 및 8.6 버전에서 KVM 사용
...
NOTE: ONTAP Select 9.9.1부터 Intel Xeon Sandy Bridge 이상 기반의 CPU 모델만 지원됩니다.
