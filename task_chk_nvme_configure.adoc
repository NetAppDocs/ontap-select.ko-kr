...
* ESXi 호스트의 경우, 지원되는 Deploy 관리 유틸리티가 포함된 ONTAP Select 9.7 이상
...
** Rocky Linux 10.1, 10.0, 9.7, 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0, 8.9, 8.8, 8.7 및 8.6
...
link:kvm-host-configuration-and-preparation-checklist.html["호스트 준비 체크리스트"]을 따르고, link:reference_chk_deploy_req_info.html["배포 유틸리티 설치"] 및 link:reference_chk_select_req_info.html["ONTAP Select 설치"]에 필요한 정보를 검토하십시오.
