...
link:kvm-host-configuration-and-preparation-checklist.html["호스트 준비 체크리스트"]자세한 내용은 를 따라link:reference_chk_deploy_req_info.html["배포 유틸리티 설치에 필요한 정보"], 및 link:reference_chk_select_req_info.html["ONTAP Select 설치에 필요한 정보입니다"]항목을 검토하십시오.
