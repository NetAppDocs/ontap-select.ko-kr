...
.클러스터의 위치 및 중재자 서비스
2노드 클러스터는 일반적으로 원격 사무실이나 지점 사무실에 배포되므로 기업 데이터 센터와 멀리 떨어져 있을 수 있으며 ONTAP Select Deploy 유틸리티에서 관리 지원을 제공할 수 있습니다.  이 구성을 사용하면 ONTAP Select Deploy 유틸리티와 클러스터 간의 관리 트래픽이 WAN을 통해 흐릅니다. 제한 사항에 대한 자세한 내용은 릴리스 노트를 참조하십시오.
